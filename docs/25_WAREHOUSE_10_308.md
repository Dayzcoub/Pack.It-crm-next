...
- the label describes unsaved client-side draft provenance;
- it is not a shortage status, domain-history field, or audit flag;
- the original proposal remains owned by `shortages`.
